...
export type AppCategory =
  ...
  | "communication"
  | "other";
export type InstallPriority = "先装" | "高频" | "按需" | "了解即可";
...
export const apps: AppEntry[] = [
  {
    ...
    installPriority: "先装",
    beginnerAdvice: "先用 Gmail 注册其他所有海外账号，它是你的数字身份基础。",
  ...
  },
  {
    ...
    installPriority: "先装",
    beginnerAdvice: "到海外后第一时间安装，家人朋友沟通全靠它。",
    beginnerRecommended: true,
  },
  {
    name: "YouTube",
    ...
    installPriority: "先装",
    beginnerAdvice: "学外语和了解当地生活最快的方式，每天刷 30 分钟就够了。",
    beginnerRecommended: true,
  },
  {
    name: "Wikipedia",
    ...
    installPriority: "高频",
    beginnerAdvice: "遇到不懂的概念先搜 Wikipedia，比搜索引擎更准确。",
    beginnerRecommended: true,
  },
  {
    name: "X（Twitter）",
    ...
    installPriority: "高频",
    beginnerAdvice: "关注几个华人资讯博主和本地新闻账号，快速了解海外动态。",
    beginnerRecommended: true,
  },
  {
    name: "Instagram",
    ...
    installPriority: "高频",
    beginnerAdvice: "搜索你所在城市的标签（如 #TorontoLife），发现本地好去处。",
    beginnerRecommended: true,
  },
  {
    name: "Reddit",
    ...
    installPriority: "高频",
    beginnerAdvice: "搜索你所在城市的 subreddit（如 r/Toronto），本地信息最真实。",
    beginnerRecommended: true,
  },
  {
    name: "Spotify",
    ...
    installPriority: "按需",
    beginnerAdvice: "免费版就够用了，先不用急着买 Premium。",
    beginnerRecommended: true,
  },
  {
    name: "Telegram",
    ...
    installPriority: "按需",
    beginnerAdvice: "加入当地华人互助群很有用，但注意识别诈骗信息。",
    beginnerRecommended: true,
  },
  {
    name: "GitHub",
    ...
    installPriority: "按需",
    beginnerAdvice: "即使不写代码，很多免费好用的工具都能在 GitHub 找到。",
  ...
  },
  {
    ...
    installPriority: "按需",
    beginnerAdvice: "如果你用 ChatGPT 或其他 AI 工具，它们的官方社区大多在 Discord。",
    beginnerRecommended: false,
  },
  {
    name: "Facebook",
    ...
    installPriority: "按需",
    beginnerAdvice: "Facebook Marketplace 买二手家具很方便，但一定要面交。",
    beginnerRecommended: false,
  },
  {
    name: "LinkedIn",
    ...
    installPriority: "按需",
    beginnerAdvice: "找工作的话，LinkedIn 上完善个人资料是第一步。",
    beginnerRecommended: false,
  },
  {
    name: "Google Voice",
    ...
    installPriority: "按需",
    beginnerAdvice: "如果能注册到就先注册，以后可能用得上。注册不到的话也不用纠结。",
    beginnerRecommended: false,
  },
  {
    name: "TikTok",
    ...
    installPriority: "按需",
    beginnerAdvice: "娱乐用就好，搜索本地生活标签能发现不少有用内容。",
    beginnerRecommended: false,
  },
  {
    name: "Pinterest",
    ...
    installPriority: "了解即可",
    beginnerAdvice: "装修或做手工时用得上，不急。",
    beginnerRecommended: false,
  },
  {
    name: "Quora",
    ...
    installPriority: "了解即可",
    beginnerAdvice: "搜索「Moving to [城市名] Quora」能找到不少真实经验分享。",
    beginnerRecommended: false,
  },
  {
    name: "Tor Browser",
    ...
    installPriority: "了解即可",
    beginnerAdvice: "普通用户不需要。了解它存在即可，不建议新手折腾。",
    beginnerRecommended: false,
  },
];
...
export const ratingInfo: Record<AppRating, { label: string; color: string; bg: string; desc: string; advice: string }> = {
  S: { label: "S", color: "text-amber-700", bg: "bg-amber-100", desc: "必装，没有替代", advice: "出海第一天建议先装" },
  A: { label: "A", color: "text-green-700", bg: "bg-green-100", desc: "强烈推荐", advice: "高频使用，适合长期保留" },
  B: { label: "B", color: "text-blue-700", bg: "bg-blue-100", desc: "按需安装", advice: "按需安装，不是人人都需要" },
  C: { label: "C", color: "text-gray-600", bg: "bg-gray-100", desc: "特定需求", advice: "有用但不优先" },
  D: { label: "D", color: "text-red-700", bg: "bg-red-100", desc: "谨慎使用", advice: "新手先了解，不建议一开始折腾" },
};
