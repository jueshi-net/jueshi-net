...
export const documentTypes: DocumentTypeMeta[] = [
  ...
  // ===== 标签系列（Label Types — 热敏纸打印） =====
  {
    type: "inbound-label",
    titleZh: "集运入库标签",
    titleEn: "Inbound Label",
    category: "core",
    description: "集运仓库入库标签，含订单号、客户代码、仓位信息，支持热敏纸打印",
    scenario: "集运仓库入库、包裹识别、客户对账",
    isFree: true,
    isOnline: true,
    icon: "📥",
    exportFileNamePrefix: "IL",
  },
  {
    ...
    scenario: "集运合箱、国际快递打包、子包裹标识",
    isFree: true,
    isOnline: true,
    icon: "📫",
    exportFileNamePrefix: "CL",
  },
  {
    type: "pallet-label",
    titleZh: "托盘标签",
    ...
    scenario: "托盘堆叠、仓库出货、整托识别",
    isFree: true,
    isOnline: true,
    icon: "🏗️",
    exportFileNamePrefix: "PLT",
  },
  {
    type: "location-label",
    titleZh: "库位标签",
    ...
    scenario: "仓库管理、货位标识、拣货指引",
    isFree: true,
    isOnline: true,
    icon: "📍",
    exportFileNamePrefix: "LL",
  },
  {
    type: "reminder-label",
    titleZh: "提示标签",
    ...
    scenario: "仓储提示、物流警示、特殊处理标识",
    isFree: true,
    isOnline: true,
    icon: "⚠️",
    exportFileNamePrefix: "RL",
  },
