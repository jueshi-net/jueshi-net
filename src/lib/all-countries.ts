...
const tier2Data: AllCountryConfig[] = [
  ...
  makeTier2("uae","AE","United Arab Emirates","阿联酋","Asia","Western Asia","Abu Dhabi",["Dubai", "Abu Dhabi", "Sharjah", "Ajman", "Al Ain"],"Asia/Dubai","AED","UAE Dirham","+971","Postal Code","NNNNN","Ahmed Ali\nSheikh Zayed Road\nDubai\nUnited Arab Emirates","https://www.epg.ae",["Arabic", "English"]),
