        ...
        {IDENTITY_CARDS.map(card => {
          ...
          return (
            <a
              key={card.title}
              href={card.href}
              className="group relative overflow-hidden bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-5 shadow-sm shadow-gray-100/30 hover:shadow-lg hover:shadow-gray-200/50 hover:-translate-y-0.5 hover:border-gray-200 transition-all duration-200"
            >
              {/* Gradient top bar */}
