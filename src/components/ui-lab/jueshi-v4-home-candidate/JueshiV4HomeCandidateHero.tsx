...
import { Mail, Package, RefreshCw, Truck, FileText, CheckSquare, ArrowRight, TrendingUp, Compass, Bookmark } from 'lucide-react';
...
export default function JueshiV4HomeCandidateHero() {
  return (
    <section className="mb-10 md:mb-12">
      <div className="relative overflow-hidden rounded-[28px] border border-[#E8ECF3] shadow-[0_20px_50px_rgba(108,93,211,0.08)]">
        ...
        <div className="relative p-6 md:p-10 lg:p-14">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_520px] gap-10 lg:gap-14 items-center min-h-[400px] lg:min-h-[440px]">
            {/* Left content */}
