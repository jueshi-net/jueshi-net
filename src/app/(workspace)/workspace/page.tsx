  ...
  return (
    <div className="min-h-screen bg-[#F6F8FC]">
      ...
      <div className="flex">
        ...
        <div className="flex-1 lg:pl-60">
          ...
          <main className="p-4 md:p-6 lg:p-8 pb-24 lg:pb-8">
            <div className="max-w-[1180px] mx-auto space-y-6">
              {/* Welcome Section */}
              <section className="bg-gradient-to-br from-[#6C5DD3] via-[#5b4fc4] to-[#3F8CFF] rounded-2xl p-6 md:p-8 text-white shadow-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                        ...
                        <span className="font-semibold text-sm">{user?.growthValue ?? 0}</span>
                        <span className="text-white/80 text-sm">成长值</span>
                      </div>
                      <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
              ...
              {/* Quick Actions */}
              <section>
                <h3 className="text-lg font-semibold text-[#11142D] mb-4">快速操作</h3>
              ...
              {/* Core Metrics */}
              <section>
                <h3 className="text-lg font-semibold text-[#11142D] mb-4">核心数据</h3>
              ...
              {/* Growth Operations */}
              <section>
                <h3 className="text-lg font-semibold text-[#11142D] mb-4">成长运营</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <SectionCard title="成长等级" subtitle={levelLabel}>
                    <div className="space-y-3">
                      ...
                      <div className="w-full bg-gray-100 rounded-full h-2">
                        <div
                          className="bg-gradient-to-r from-[#6C5DD3] to-[#3F8CFF] h-2 rounded-full transition-all"
                  ...
                  <SectionCard
                    title="我的勋章"
                    action={<Link href="/workspace/member" className="text-xs text-[#6C5DD3] hover:underline">查看全部</Link>}
                  >
                  ...
                  <SectionCard
                    title="今日任务"
                    action={<Link href="/workspace/tasks" className="text-xs text-[#6C5DD3] hover:underline">全部</Link>}
                  >
              ...
              {/* Recent Work */}
              <section>
                <h3 className="text-lg font-semibold text-[#11142D] mb-4">最近工作</h3>
        ...
        {/* Right Rail - Only visible on xl screens */}
        <WorkspaceRightRail
