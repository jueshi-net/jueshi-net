...
import { FileText, CalendarDays, Eye, Clock, Search, Tag, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-8 pb-16">
        {dbError ? (
          <div className="bg-white rounded-xl border border-red-200 dark:border-red-800 p-16 text-center">
            <AlertTriangle className="w-12 h-12 text-red-400 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-gray-900 mb-2">数据加载失败</h3>
            <p className="text-gray-500">数据库连接异常，请稍后再试</p>
          </div>
        ) : (
          <>
