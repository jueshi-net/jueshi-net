...
const categories: CategoryCard[] = [
  ...
  },
  {
    ...
    links: [
      { name: '17TRACK', href: 'https://www.17track.net', external: true },
      { name: '运费计算器', href: '/tools/shipping-calculator' },
      { name: 'HS编码查询', href: '/tools/hs-code' },
      { name: '单据中心', href: '/tools/documents' },
    ],
  },
  {
    title: '公司邮箱',
