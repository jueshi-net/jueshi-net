          ...
          {categories.map((cat) => {
            ...
            return (
              <Link
                ...
                className="group rounded-xl border border-gray-200 bg-white p-3 hover:border-teal-300 hover:shadow-sm transition flex flex-col gap-1"
              >
                <div className="flex items-center justify-between">
                  <span className="text-xl leading-none" aria-hidden>
                    {cat.iconText || "💬"}
                  </span>
                  <span className="text-[10px] text-gray-400 group-hover:text-teal-500 transition">
                    {count} 帖
                  </span>
                </div>
                <div className="text-sm font-semibold text-gray-800 group-hover:text-teal-700 transition">
                  {cat.name}
                </div>
                {cat.description && (
