            ...
            <div className="lg:sticky lg:top-20 self-start">
              <div ref={previewRef} className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-8 min-h-[700px] overflow-x-auto" style={{ fontFamily: "Arial, sans-serif" }}>
                <div className="min-w-[280px]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6 text-sm"><div><span className="text-gray-500">报价日期: </span><span className="font-medium">{quoteDate}</span></div><div><span className="text-gray-500">有效期至: </span><span className="font-medium">{validUntil || "—"}</span></div></div>
