...
export default async function VideoScriptSopPage({ searchParams }: { searchParams: Promise<{ draftId?: string }> }) {
  const params = await searchParams;
  return <VideoScriptSopClient draftId={params.draftId || null} />;
}
