  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16">
        ...
        {/* Tool Reviews */}
        <ToolReviewPanel toolKey="product-copy" isLoggedIn={typeof window !== 'undefined' && (document.cookie.includes('next-auth.session-token') || document.cookie.includes('__Secure-next-auth.session-token') || document.cookie.includes('authjs.session-token') || document.cookie.includes('__Secure-authjs.session-token'))} />
