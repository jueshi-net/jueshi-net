# Workspace Page Migration: /workspace/member

## Context
You are migrating /workspace/member to use the shared WorkspacePageFrame component.

## Current State
- Page file: src/app/(workspace)/workspace/member/page.tsx
- Client file: src/app/(workspace)/workspace/member/member-client.tsx
- Current structure: Uses max-w-6xl mx-auto wrapper
- No RightRail currently

## Target State
1. Import and wrap content with WorkspacePageFrame
2. Pass WorkspaceRightRail as rightRail prop
3. Remove max-w-6xl mx-auto from client component
...
// In the component, wrap MemberClient with WorkspacePageFrame
// Pass WorkspaceRightRail with required props (fetch data if needed)
```

### member-client.tsx
```typescript
// Remove: <div className="max-w-6xl mx-auto">
...
ACTUAL_CHANGED_FILES=src/app/(workspace)/workspace/member/page.tsx,src/app/(workspace)/workspace/member/member-client.tsx
