# Workspace Page Migration: /workspace/tasks

## Context
You are migrating /workspace/tasks to use the shared WorkspacePageFrame component.

## Current State
- Page file: src/app/(workspace)/workspace/tasks/page.tsx
- Client file: src/app/(workspace)/workspace/tasks/tasks-client.tsx
...
// In the component, wrap TasksClient with WorkspacePageFrame
...
ACTUAL_CHANGED_FILES=src/app/(workspace)/workspace/tasks/page.tsx,src/app/(workspace)/workspace/tasks/tasks-client.tsx
