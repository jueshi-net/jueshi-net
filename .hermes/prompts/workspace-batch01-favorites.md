# Workspace Page Migration: /workspace/favorites

## Context
You are migrating /workspace/favorites to use the shared WorkspacePageFrame component.

## Current State
- Page file: src/app/(workspace)/workspace/favorites/page.tsx
- Client file: src/app/(workspace)/workspace/favorites/favorites-client.tsx
...
// In the component, wrap FavoritesClient with WorkspacePageFrame
...
ACTUAL_CHANGED_FILES=src/app/(workspace)/workspace/favorites/page.tsx,src/app/(workspace)/workspace/favorites/favorites-client.tsx
