CURRENT_TASK=HERMES_PAYMENT_SUCCESS_V4_SHELL_INTEGRATION
ROUTE=/payment/success
FILE=src/app/(public)/payment/success/page.tsx
GOAL=将支付成功页面接入 V4 Public Shell，统一页面布局风格
...
必须保留：
- 业务逻辑（支付成功展示、sessionId 显示、已解锁功能列表）
- 数据（功能列表、按钮文案）
- 链接（前往工作台、探索工具）
- 路由（/payment/success）
- SEO 语义
...
PAGE_EDIT_COMPLETE
ACTUAL_CHANGED_FILES=src/app/(public)/payment/success/page.tsx
