CURRENT_TASK=EXPANDED_BATCH_04_NOTIFICATIONS
ROUTE=/workspace/notifications
FILE=src/app/(workspace)/workspace/notifications/notifications-client.tsx
PAGE_TYPE=workspace_client
GOAL=优化 /workspace/notifications 页面的 UI 布局和移动端体验

你是本任务的代码执行者。

请先读取这个精确文件：src/app/(workspace)/workspace/notifications/notifications-client.tsx
