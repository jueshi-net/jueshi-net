...
BRIDGE_SECRET=*** find-generic-password -s 'jueshi-contentops-bridge' -a 'staging' -w 2>/dev/null`)
BOT_TOKEN=*** find-generic-password -s 'jueshi-contentops-telegram' -a 'fabuxia_bot' -w 2>/dev/null`)
